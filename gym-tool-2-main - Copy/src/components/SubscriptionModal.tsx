...
export default function SubscriptionModal({ isOpen, onClose, plan, onSubmit }: SubscriptionModalProps) {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-gray-900 rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto border border-white/10">
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <h2 className="text-xl font-semibold text-white">Subscribe to {planTitles[plan]}</h2>
            <button
              onClick={onClose}
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-gray-300">
                      Send <span className="font-semibold text-white">{prices[plan]} DA</span> to:
                    </p>
